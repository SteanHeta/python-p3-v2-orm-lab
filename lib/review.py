...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year  # This will use the property setter
        self.summary = summary  # This will use the property setter
        self.employee_id = employee_id  # This will use the property setter
    ...
    def year(self, year):
        ...
        if year < 2000:  # Assuming reasonable minimum year
    ...
    # ... (rest of the ORM methods remain exactly the same as before)
    @classmethod
